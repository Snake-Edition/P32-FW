...
// private variables
    ...
    { "EXTRUDER_TYPE",   VARIANT8_UI8,   1, 0 }, // EEVAR_SNAKE_EXTRUDER_TYPE
    { "EXTRUDER_ESTEPS", VARIANT8_FLT,   1, 0 }, // EEVAR_SNAKE_EXTRUDER_ESTEPS
    { "HOTEND_FAN_SPD",  VARIANT8_UI8,   1, 0 }, // EEVAR_SNAKE_HOTEND_FAN_SPEED
    { "SKEW_ENABLED",    VARIANT8_BOOL,  1, 0 }, // EEVAR_SNAKE_SKEW_ENABLED
    { "SKEW_XY",         VARIANT8_FLT,   1, 0 }, // EEVAR_SNAKE_SKEW_XY
    { "SKEW_XZ",         VARIANT8_FLT,   1, 0 }, // EEVAR_SNAKE_SKEW_XZ
    { "SKEW_YZ",         VARIANT8_FLT,   1, 0 }, // EEVAR_SNAKE_SKEW_YZ
    { "EXTRUDER_REV",    VARIANT8_UI8,   1, 0 }, // EEVAR_SNAKE_EXTRUDER_REVERSE
