...
void marlin_set_skew_xy(float val) {
    marlin_set_variable(marlin_vars()->skew_xy, val);
}

void marlin_set_skew_xz(float val) {
    marlin_set_variable(marlin_vars()->skew_xz, val);
}

void marlin_set_skew_yz(float val) {
    marlin_set_variable(marlin_vars()->skew_yz, val);
}
