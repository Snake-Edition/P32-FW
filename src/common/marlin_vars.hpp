...
public:
    ...
    MarlinVariable<float> skew_xy;
    MarlinVariable<float> skew_xz;
    MarlinVariable<float> skew_yz;
    MarlinVariable<float> esteps;
    ...
    // 1B base types
    MarlinVariable<uint8_t> EXTRUDER_REVERSE; // bool; reversion of extruder
