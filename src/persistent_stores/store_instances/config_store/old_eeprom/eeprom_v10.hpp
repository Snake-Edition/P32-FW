...
constexpr vars_body_t body_defaults = {
    ...
    old_footer_encode({ std::to_underlying(FooterItems::ItemSpeed), std::to_underlying(FooterItems::ItemLiveZ), std::to_underlying(FooterItems::ItemFilament) }), // EEVAR_FOOTER_SETTING // proper v10 default
#else
