...
#endif
{
    ...
    StoreItem<std::array<char, connect_host_size + 1>, defaults::connect_proxy_host, ItemFlag::network | ItemFlag::dev_items, journal::hash("Connect Proxy Host")> connect_proxy_host;
