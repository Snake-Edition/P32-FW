...
using Screen = ScreenMenu<EFooter::On, MI_RETURN,
    MI_BRIGHTNESS, MI_HOTEND_FAN_SPEED, MI_SKEW_ENABLED, MI_SKEW_XY, MI_SKEW_XZ, MI_SKEW_YZ, MI_NOZZLE_CALIBRATION_TEMP, MI_CALIBRATE_NOZZLE_PID, MI_BED_CALIBRATION_TEMP, MI_CALIBRATE_BED_PID>;
