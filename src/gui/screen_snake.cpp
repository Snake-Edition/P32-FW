...
static const constexpr Color color_snake = COLOR_ORANGE;
static const constexpr Color color_food = COLOR_LIME;
static const constexpr Color color_bg = COLOR_BLACK;
static const constexpr Color color_dead = COLOR_RED;
...
void screen_snake_data_t::draw_block(const point_ui8_t point, const Color color) {
    display::fill_rect(Rect16(point.x * block_size, point.y * block_size, block_size, block_size), color);
}
...
void screen_snake_data_t::windowEvent(window_t * /*sender*/, GUI_event_t event, void * /*param*/) {
