...
static constexpr NumericInputConfig pid_calib_spin_config {
    .min_value = 0,
    .max_value = 300,
...
MI_NOZZLE_CALIBRATION_TEMP::MI_NOZZLE_CALIBRATION_TEMP()
    : WiSpin(nozzle_calibration_temp, pid_calib_spin_config, _(label)) {};
...
MI_BED_CALIBRATION_TEMP::MI_BED_CALIBRATION_TEMP()
    : WiSpin(bed_calibration_temp, pid_calib_spin_config, _(label)) {};
