...
#ifdef _DEBUG
using Screen = ScreenMenu<EFooter::On, MI_RETURN, MI_SNAKE_SETTINGS, MI_TEMPERATURE, MI_CURRENT_PROFILE, MI_MOVE_AXIS, MI_DISABLE_STEP,
...
using Screen = ScreenMenu<EFooter::On, MI_RETURN, MI_SNAKE_SETTINGS, MI_TEMPERATURE, MI_CURRENT_PROFILE, MI_MOVE_AXIS, MI_DISABLE_STEP,
    ...
    MI_LANGUAGE, MI_EXPERIMENTAL_SETTINGS, MI_FACTORY_DEFAULTS>;
#endif
