...
using namespace phase_stepping_old;
using namespace phase_stepping::opts;
using phase_stepping::SpectralItem;
...
int phase_stepping_old::sin_lut(int x, int range) {
...
int phase_stepping_old::cos_lut(int x, int range) {
    return sin_lut(x + SIN_PERIOD / 4, range);
}

int phase_stepping_old::normalize_sin_phase(int phase) {
...
int phase_stepping_old::normalize_motor_phase(int phase) {
